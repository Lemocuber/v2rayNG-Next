...
object AppConfig {
    ...
    const val PREF_PROXIED_ONLY_APPS = "pref_proxied_only_apps"
    const val PREF_PROXIED_ONLY_APPS_SET = "pref_proxied_only_apps_set"
    const val PREF_PROXIED_ONLY_APPS_INVERT = "pref_proxied_only_apps_invert"
    const val PREF_PROXIED_ONLY_APPS_SESSION_ACTIVE = "pref_proxied_only_apps_session_active"
    const val PREF_PROXIED_ONLY_APPS_LAST_APPLIED_SET = "pref_proxied_only_apps_last_applied_set"
    const val PREF_PROXIED_ONLY_APPS_LAST_APPLIED_STATE = "pref_proxied_only_apps_last_applied_state"
    ...
    const val APP_URL = "$GITHUB_URL/Lemocuber/v2rayNG-Next"
    const val APP_API_URL = "https://api.github.com/repos/Lemocuber/v2rayNG-Next/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/Lemocuber/v2rayNG-Next/master/CR.md"
    const val TG_CHANNEL_URL = "https://t.me/lemocuber"
...
//    const val IP_API_URL = "https://speed.cloudflare.com/meta"
    ...
    const val RAY_NG_CHANNEL_NAME = "v2rayNG Next Background Service"
